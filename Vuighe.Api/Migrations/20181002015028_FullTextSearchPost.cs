...
{
    public partial class FullTextSearchPost : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"create or replace function update_post_ts_vector_trigger() returns trigger as $$
            begin
            ...
            migrationBuilder.Sql(@"CREATE TRIGGER post_search_vector_update BEFORE INSERT OR UPDATE
                ON ""Posts"" FOR EACH ROW EXECUTE PROCEDURE
                update_post_ts_vector_trigger(""SearchVector"", 'pg_catalog.simple', ""Title"");");

            // force update
            migrationBuilder.Sql("UPDATE \"Posts\" SET \"Title\" = \"Title\";");
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"DROP TRIGGER post_search_vector_update on ""Posts""");
            migrationBuilder.Sql(@"drop function update_post_ts_vector_trigger");
        }
    }
}
